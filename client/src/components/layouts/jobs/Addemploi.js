...
import { addEmploie } from '../../../actions/emploi';
...
<div>
      ...
      <form>
        ...
        {error && <h2 style={{color:'red'}}>{error}</h2>}
         <button  onSubmit={handleSabmit}  onClick={()=>{dispatch(addEmploie({
         titre:titre,desc,salaire,adresse
      }));history.push('/emploi')}}>submit</button>
        </div>
      </form>
    </div>
    </div>
